...
const jobHits = jobData.hits;
 ...
 console.log(jobHits);
 const firstJobHit = jobData.hits[0];
 console.log("first job hit");
 console.log(firstJobHit);
 const jobTitleOfFirstJob = firstJobHit.jobTitle;
 console.log("jobtitle of first job");
 console.log(jobTitleOfFirstJob);
 const benefit = firstJobHit.benefits;
 console.log("benefit");
 console.log(benefit);
 for (let key of benefit) {
   console.log(key.benefitValue);
 }
 console.log("___________");
 for (let hit of jobHits) {
